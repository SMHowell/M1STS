...
if M.vRes>0  
    ...
    %   top:
    M.freezeRateTop = ((vResOld*3/4/pi)^(1/3)-(M.vRes*M.ratioEtop*3/4/pi)^(1/3)) / M.dt * 100/365.25/24/3600; % in cm/yr
    %   bottom:
    M.freezeRateBot = ((vResOld*3/4/pi)^(1/3)-(M.vRes*M.ratioEbot*3/4/pi)^(1/3)) / M.dt * 100/365.25/24/3600; % in cm/yr
